...
namespace Ambev.DeveloperEvaluation.ORM.Migrations
{
    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RatingRate = table.Column<decimal>(type: "numeric(4,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    NameFirstname = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    NameLastname = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    ...
                    AddressNumber = table.Column<int>(type: "integer", nullable: true),
                    AddressZipcode = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    AddressGeolocationLat = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    AddressGeolocationLong = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.Sql(@"
                INSERT INTO ""Users"" (
                    ...
                    ""AddressZipcode"", ""AddressGeolocationLat"", ""AddressGeolocationLong""
                ) VALUES (
                    'a1b2c3d4-e5f6-7890-abcd-ef1234567890',
                    'admin',
                    'admin@developerstore.com',
                    '+5511999999999',
                    '$2a$11$hGAaNwnVO9yzDn511y.ky.xauXXZf9bmehnfUErVFS3KdkLWfLQVu',
                    'Admin',
                    'Active',
                    NOW(),
                    'System',
        ...
        {
            migrationBuilder.Sql(@"DELETE FROM ""Users"" WHERE ""Id"" = 'a1b2c3d4-e5f6-7890-abcd-ef1234567890';");
